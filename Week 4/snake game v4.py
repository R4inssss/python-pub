...
# snek setup
snake_color = (0, 255, 0)  # green boyo
...
def move_snake():
    global direction, food_pos  # we made direction a global variable. this is to fix the issue of the food (now an apple) not being registered by the snake
    if direction == 'UP':
...
while run:
    ...
    # if food is eaten, generate new food position and grow snake
...
# nothing worked yet
# Made food_pos a global variable
