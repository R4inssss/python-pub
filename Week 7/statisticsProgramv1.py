...
class populationStdDeviation:
    ...
    def calculate_probability(self):
        ...
        print(f"The standard deviation of the sampling distribution is: {sigma}")


# should I use a dictionary here to make this more pretty? Maybe.
def main_menu():
    options = {
        '1': oneBoundaries,
        '2': area,
